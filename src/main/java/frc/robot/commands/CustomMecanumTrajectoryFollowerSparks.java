...
public class CustomMecanumTrajectoryFollowerSparks extends CommandBase {
   ...
   */
  public CustomMecanumTrajectoryFollowerSparks(PathPlannerTrajectory trajectory, Supplier<Rotation2d> desiredRotation,
    boolean outputWheelSpeeds, MecanumWithSparks driveSubsystem) {
    PIDController xController = new PIDController(MecConstants.xP, MecConstants.xI, MecConstants.xD);
    PIDController yController = new PIDController(MecConstants.xP, MecConstants.xI, MecConstants.xD);
    ProfiledPIDController rProfiledPIDController =
    new ProfiledPIDController(
   ...
   * @param driveSubsystem the driveSubsystem to use/require
   */
  public CustomMecanumTrajectoryFollowerSparks(PathPlannerTrajectory trajectory, boolean outputWheelSpeeds,
  MecanumWithSparks driveSubsystem) {
      PIDController xController = new PIDController(MecConstants.xP, MecConstants.xI, MecConstants.xD);
      PIDController yController = new PIDController(MecConstants.xP, MecConstants.xI, MecConstants.xD);
      ProfiledPIDController rProfiledPIDController =
